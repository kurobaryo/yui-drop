...
**Anonymous, ephemeral file & text sharing with a 6-digit pickup code.**

A modern, self-hostable file-codebox: drop a file, get a code, share the code.
Linear-inspired UI, mobile-friendly, multi-language (EN / 中文 / 日本語), light + dark mode.

[Live demo](https://drop.leod.me) · [Quick start](#quick-start) · [中文说明](./README.zh-CN.md)

🔒 **Secure by design** — TLS 1.3, AES-256 at-rest (R2 SSE), strict CSP, rate-limited.
✨ **Modern** — React 18, FastAPI, SQLAlchemy 2.0, S3 multipart direct upload.
...
- 🌐 **Tri-lingual** — English, 简体中文, 日本語; auto-detect, user-overridable
